...
namespace Frontend.Pages.Shipment
{
    public class EditModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(int id)
        {
            ...
            var docResponse = await httpClient.GetAsync($"api/DocumentShipping/{id}");
            ...
            Shipment = JsonSerializer.Deserialize<ShipmentViewModel>(jsonString, new JsonSerializerOptions { PropertyNameCaseInsensitive = true });
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            await httpClient.PutAsync($"api/DocumentShipping/{Shipment.Id}", jsonContent);
